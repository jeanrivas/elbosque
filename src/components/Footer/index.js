...
import { FooterContainer, FooterWrap, FooterLinksContainer, FooterLinksWrapper, FooterLinksItem, FooterLinkTitle, FooterLink, SocialMedia, SocialMediaWrap, SocialLogo, WebsiteRights, SocialIcons, SocialIconLinks } from './FooterElements';
const Footer = () => {
    return (
        <FooterContainer>
            <FooterWrap>
                ...
                <SocialMedia>
                    <SocialMediaWrap>
                        ...
                        <WebsiteRights>ElBosque R {new Date().getFullYear()} 
                            All right reserverd.</WebsiteRights>
                        <SocialIcons>
